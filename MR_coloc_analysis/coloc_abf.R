...
for (i in CVD_phenos) { # loop to read in outcome, preprocess, run coloc
  ...
  for (j in 1:length(signif_snps)) { # loop to run colocalisation for each of the significant SNPs in exposure
    ...
    #harmonising for weirdo snps # I don't think is necessary for my data..
