...
Here we map Here we map genes and variants at the LRCH1 locus to the single-cell and bulk transcriptomics carotid plaque data, and other plaque-derived traits. These are given in:

- `Variants.xlsx - sheet Variants`
- `Genes.xlsx`

We used variants from GTEx Portal associated to expression in whole blood as expression quantitative trait loci (eQTLs). These were on b38, and chr:bp were looked up with dbSNP for b37 - which is the build for the AE.
